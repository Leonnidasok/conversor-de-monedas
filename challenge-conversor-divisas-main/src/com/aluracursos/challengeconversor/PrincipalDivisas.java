        ...
        while (true) {
            ...
            while (true) {
                ...
                if (listaDeDivisas.stream().anyMatch(currency -> currency.getCurrencyCode().equals(divisaABuscar))) {
                    ...
                    System.out.println("Programa finalizado. ¡Gracias por usar el conversor de monedas de Alvaro Perez!");
                    break outerLoop;
                } else {
            ...
            try {
                ...
                while (true) {
                    if (otraOperacion.equals("no") || otraOperacion.equals("salir")) {
                        System.out.println("Programa finalizado, gracias por usar el conversor de divisas de Alvaro Perez.");
                        break outerLoop;
